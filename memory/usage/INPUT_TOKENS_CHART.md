...
Exibir a distribuição temporal dos input tokens entre tokens sem cache e tokens em cache.
...
O componente busca os buckets do período selecionado, exibe as séries empilhadas e usa o nome declarado em cada `Bar` no tooltip.
